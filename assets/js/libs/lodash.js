...
(function (window, undefined) {
  ...
  var extendIteratorOptions = {
    ...
    'args':'object',
    'init':'object',
    'top':'for (var iterateeIndex = 1, length = arguments.length; iterateeIndex < length; iterateeIndex++) {\n' +
  ...
  var groupBy = createIterator(baseIteratorOptions, {
    'init':'{}',
    'top':'var prop, isFunc = typeof callback == \'function\';\n' +
  ...
  var invoke = createIterator(mapIteratorOptions, {
    ...
    'inLoop':{
      'array':'result[index] = (isFunc ? methodName : iteratee[index][methodName])' +
  ...
  var reduce = createIterator({
    ...
    'inLoop':{
      'array':'result = callback(result, iteratee[index], index, collection)',
  ...
  var bindAll = createIterator({
    ...
    'top':'var funcs = arguments,\n' +
      ...
      '  return result\n' +
      '}',
    'inLoop':'if (toString.call(result[index]) == funcClass)' +
